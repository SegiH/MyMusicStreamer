// FIXED
//
// Fixed bug when automatically set delimiter. getMusicPath() automatically sets it now
...
$("#autofill").keydown(function(e){
    ...
    $('.items li').each(function() {  
         if ( $(this).text().substring(0,1).toLowerCase() == String.fromCharCode(e.keyCode+32) ) {
              $('.items li').removeClass("selected");
